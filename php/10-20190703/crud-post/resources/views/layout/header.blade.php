        ...
        <div class=" bg-light ">
            <div class="navbar navbar-expand-md">
                <div class="col-4 d-flex justify-content-between">
                    <div class="row ">
                        <div class="col-4">
                            <img src="https://scontent.fdad3-1.fna.fbcdn.net/v/t1.15752-9/67099728_461147137998582_4124829528142905344_n.png?_nc_cat=110&_nc_oc=AQnl9QZ9aHH-7xAXId3DikZXdM3ZBlEVqVON1JLlyQDUhdtfbjekR4awtRak73-q2zNpzGoYNF1my6Rh-UZK5hZ-&_nc_ht=scontent.fdad3-1.fna&oh=3b5963cabf786ac16c871d9a9c79b876&oe=5DAD74DD"
                ...
                <button class="btn  btn-outline-primary max-5 ">Articles</button>
                                        ...
                                        <li><a class=" px-3"  href="">Nổi bật</a></li>
                                    </div>
                                </ul>
                            </h2>
                        </div>
                ...
                <div class="collapse" id="navbarHeader">
                    <h2 class="card-text ">
                        <ul class="list-unstyled">
                            <li class="bg-dark my-3 d-flex text-white"><div class="list-unstyled d-flex m-0 my-4">
                                    <form action="{{asset('articles')}}" method="get">
                <button class="btn  btn-outline-primary max-5 ">Articles</button>
            </form></li>
                            <li class=" my-3 d-flex ">Tin tức</li>
                            <li class=" my-3 d-flex ">Sự Kiện</li>
                            <li class=" my-3 d-flex ">Nổi bật</li>
                        </ul>
                    </h2>
                </div>
            </div>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner ">
                            <div class="carousel-item ">
                                <img src="https://cdn.pixabay.com/photo/2016/12/01/18/17/mobile-phone-1875813__180.jpg"
                            ...
                            <div class="carousel-item active">
                                <img src="https://cdn.pixabay.com/photo/2019/05/24/17/41/castle-4226797__340.jpg"
                                    class="d-block w-100" height="350px;">
                            ...
                            <div class="carousel-item ">
                                <img src="https://cdn.pixabay.com/photo/2019/05/06/07/40/sailing-vessel-4182424__340.jpg"
                                    class="d-block w-100" height="350px;">
